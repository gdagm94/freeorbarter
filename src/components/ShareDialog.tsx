...
export function ShareDialog({ itemId, itemTitle, onClose }: ShareDialogProps) {
  ...
  const handleEmailShare = () => {
    const emailSubject = `Check out this item on FreeorBarter: ${itemTitle}`;
    const emailBody = `I found this interesting item on FreeorBarter:\n\n${itemTitle}\n\nCheck it out here: ${shareUrl}`;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full relative">
        ...
        <h2 className="text-2xl font-bold mb-6">Share This Item</h2>

        <div className="space-y-4">
          {/* Copy Link */}
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            <div className="flex-1 truncate">
              <p className="text-sm font-medium text-gray-900">Item Link</p>
