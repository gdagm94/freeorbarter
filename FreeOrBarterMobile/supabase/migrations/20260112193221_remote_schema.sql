drop policy "Users can create threads in their conversations" on "public"."message_threads";

drop policy "Users can delete threads they created" on "public"."message_threads";

drop policy "Users can update threads they created" on "public"."message_threads";

drop policy "Users can view threads in their conversations" on "public"."message_threads";

drop policy "message_threads_insert_allowed" on "public"."message_threads";
...
drop policy "Users can create offers" on "public"."barter_offers";

drop policy "Users can update their offers" on "public"."barter_offers";

drop policy "Users can view their offers" on "public"."barter_offers";
...
drop policy "Users can create counter offers" on "public"."counter_offers";

drop policy "Users can update counter offers they created" on "public"."counter_offers";

drop policy "Users can view counter offers they're involved in" on "public"."counter_offers";
...
drop policy "Users can add files to their messages" on "public"."message_files";

drop policy "Users can delete files from their messages" on "public"."message_files";

drop policy "Users can view files in their messages" on "public"."message_files";

drop policy "Users can add reactions to messages they can see" on "public"."message_reactions";

drop policy "Users can remove their own reactions" on "public"."message_reactions";

drop policy "Users can view reactions on their messages" on "public"."message_reactions";

drop policy "Users can send messages" on "public"."messages";

drop policy "Users can update read status of received messages" on "public"."messages";
...
drop policy "Users can create expirations for their offers" on "public"."offer_expirations";

drop policy "Users can update expirations for their offers" on "public"."offer_expirations";

drop policy "Users can view expirations for their offers" on "public"."offer_expirations";

drop policy "Users can create their own templates" on "public"."offer_templates";

drop policy "Users can delete their own templates" on "public"."offer_templates";

drop policy "Users can update their own templates" on "public"."offer_templates";

drop policy "Users can view their own templates" on "public"."offer_templates";
...
drop policy "Users can view their own history" on "public"."user_history";
...
alter table "public"."user_push_tokens" add constraint "user_push_tokens_platform_check" CHECK ((platform = ANY (ARRAY['ios'::text, 'android'::text, 'web'::text, 'unknown'::text]))) not valid;
...
CREATE TRIGGER trg_send_push_on_notifications AFTER INSERT ON public.notifications FOR EACH ROW EXECUTE FUNCTION public.send_push_for_notification();
